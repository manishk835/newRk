...
export default function CategoryMenu() {
    ...
    return (
      <div className="grid grid-cols-3 gap-8 min-w-150">
        {Array.from({ length: 6 }).map((_, i) => (
          <div key={i}>
            <div className="h-4 w-24 bg-gray-200 dark:bg-zinc-700 mb-3 rounded animate-pulse" />

            <div className="space-y-2">
              <div className="h-3 w-20 bg-gray-100 dark:bg-zinc-800 rounded animate-pulse" />
              <div className="h-3 w-16 bg-gray-100 dark:bg-zinc-800 rounded animate-pulse" />
              <div className="h-3 w-14 bg-gray-100 dark:bg-zinc-800 rounded animate-pulse" />
            </div>
          </div>
        ))}
      </div>
  ...
  if (!parentCategories.length) {
    return (
      <div className="min-w-100 text-sm text-gray-500 dark:text-gray-400">
        No categories found
      </div>
    );
  }
        ...
        return (
          ...
          >
            ...
            <Link
              ...
              className="block font-semibold text-sm mb-3 text-gray-900 dark:text-white hover:text-black dark:hover:text-gray-200 transition"
            >
              {parent.name}
            </Link>
