...
export async function generateMetadata(
  ...
  return {
    title: `${formatted} Products | Marketplace`,
    description: `Shop the best ${formatted} products from trusted vendors.`,
    openGraph: {
      title: `${formatted} Products`,
      description: `Explore top ${formatted} items.`,
      type: "website",
    },
  };
}
...
export default async function CategoryPage({
  ...
  try {
    const data = await fetchProductsByCategory(slug, sp);
