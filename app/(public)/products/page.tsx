// ======================================================
// 📄 app/(public)/products/page.tsx (UPDATED)
// ======================================================
...
export async function generateMetadata(
  ...
  let title = "All Products | RK Fashion";
  let description = "Browse products across categories.";

  if (sp.filter === "featured") title = "Featured Products";
  if (sp.filter === "new") title = "New Arrivals";
  if (sp.filter === "best") title = "Best Sellers";
  if (sp.brand) title = `${sp.brand} Products`;
